"""Django settings for the Gulmi Coffee ERP backend."""
...
WSGI_APPLICATION = "gulmi_erp.wsgi.application"
ASGI_APPLICATION = "gulmi_erp.asgi.application"

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": env("POSTGRES_DB", "gulmi_erp"),
        "USER": env("POSTGRES_USER", "gulmi_erp"),
        "PASSWORD": env("POSTGRES_PASSWORD", "gulmi_erp"),
